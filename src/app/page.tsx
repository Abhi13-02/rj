    ...
    return (
        <main className="relative w-full">
            ...
            <section className="shop_by_category text-2xl text-[#832729] pt-2 md:py-8 px-2 text-center font-bold">
                ...
                <div className={`category-content w-full flex justify-center items-center ${playFair.className} font-bold grid  grid-cols-2 grid-rows-3 md:grid-cols-3 md:grid-rows-2 gap-x-5 gap-y-3 md:gap-y-7`}>
                    <div className="flex  w-full justify-center items-center flex-col">
                        <Link href={"/products/saree"} >
                            ...
                            />
                            <span className="text-[#832729] mt-2  text-lg md:text-2xl text-center">SARES</span>
                        </Link>
                    </div>
            ...
            {/* shop by choicee */}
            <section className="shop_by_choice text-2xl text-[#832729]  p-4 md:py-8 text-center font-bold">
