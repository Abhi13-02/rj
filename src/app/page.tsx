...
function Page() {
    ...
    return (
        <main className="relative w-full">
            ...
            <section className="shop_by_category text-2xl text-[#832729] py-8 px-2 text-center font-bold">
                ...
                <div className={`category-content w-full h-full flex justify-center items-center ${playFair.className} font-bold text-md grid lg:grid-cols-3 md:grid-cols-2 grid-rows-2 lg:gap-6 md:gap-2 place-items-center justify-self-center`}>
                    <div className="flex w-full h-full justify-center items-center flex-col">
                        <Link href={"#"} >
                            <img
                                src={"/category1.webp"}
                                alt="category1"
                                className="rounded-2xl object-cover w-[500px] h-[200px]"
                            />
