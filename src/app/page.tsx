    ...
    return (
        <main className="relative w-full">
            ...
            <section className="mt-10">
                <div className={`${playFair.className} text-[#832729] font-extrabold flex justify-center items-center text-2xl`}>
                    <button className="bg-[#832729] text-white p-2 rounded-full">NEW ARRIVALS</button>
                    <span>||</span>
                    <button className="p-2">MOST LOVED</button>
                </div>
                <div className="w-full flex justify-center items-center overflow-hidden mt-6 mb-6">
                    <svg width="1204" height="19" viewBox="0 0 1204 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 9.55804H553.293" stroke="#832729" />
