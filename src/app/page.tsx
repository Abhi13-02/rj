    ...
    return (
        <main className="relative w-full">
            ...
            <section className="shop_by_category text-2xl text-[#832729] py-8 text-center font-bold">
                ...
                <div className={`category-content w-full flex justify-center items-center ${playFair.className} font-bold text-md grid lg:grid-cols-3 md:grid-cols-2 grid-rows-2 lg:gap-6 md:gap-2`}>
                    <Link href={"#"} >
