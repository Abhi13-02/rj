...
const ProductCard: React.FC<{ product: IProduct, setShowLoginPanel: React.Dispatch<React.SetStateAction<boolean>> }> = ({ product, setShowLoginPanel }) => {
  ...
  return (
    <div className= "relative shadow-sm bg-slate-50 product-card hover:bg-slate-100 hover:shadow-2xl lg:hover:scale-[1.02] rounded-lg flex-grow max-w-[180px] sm:max-w-[230px] md:max-w-[250px] lg:max-w-[300px] lg:p-2  h-full aspect-[2/4] sm:aspect-[2/4] md:aspect-[2/3] lg:aspect-[3/7] xl:aspect-[6/10]">
      {/* Out of Stock Badge */}
      {isOutOfStock && (
      ...
      <div className="px-2">
        ...
        {/* Product Price */}
        <div className="text-green-800 sm:mt-[2px] md:mt-2">
